 ...
 * Source: react-bits, src/ts-tailwind — CircularGallery.tsx (MIT).
 *
 * Kept as delivered apart from the "use client" directive above, which the
 * upstream Vite build does not need and the App Router does. Editing this
 * file means re-applying the change by hand on the next update, so prefer
 * wrapping it in our own component over patching it here.
 */
